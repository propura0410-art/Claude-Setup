...
Read [mcp-guidance.md](references/mcp-guidance.md) for tool-specific guidance on using Context7, Serena, Playwright, and Chrome DevTools during implementation. Use these tools throughout the workflow when available.
...
- [mcp-guidance.md](references/mcp-guidance.md) - MCP server tool usage (Context7, Serena, Playwright, Chrome DevTools)
