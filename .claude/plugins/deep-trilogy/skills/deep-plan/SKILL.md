...
### 5. MCP Server Guidance

Read `{plugin_root}/skills/deep-plan/references/mcp-guidance.md` for tool-specific guidance. Use the tools described there throughout the workflow when available.
